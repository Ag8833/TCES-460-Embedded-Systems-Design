...
if __name__ == '__main__':
    ...
    s = Process(target=opencv, args=(parent_conn,parent_conn2,parent_conn4,))
    r = Process(target=cannon, args=(child_conn,parent_conn3,))
    q = Process(target=navigation, args=(child_conn2,child_conn4,))
